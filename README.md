...
* สร้าง Endpoint API ใหม่ใน Backend สำหรับรับคำสั่ง "ถ่ายภาพ"

* ทดลองใช้ Library เช่น OpenCV เพื่อดึงภาพจากกล้อง

* **(ขั้นสูง)** นำภาพไปวิเคราะห์และใช้เป็นส่วนหนึ่งของข้อมูล RAG
...
2. ระบบจะถ่ายภาพนั้น → **ดึงข้อความจากภาพ** (OCR - Optical Character Recognition)
...
4. Backend **ประมวลผลภาพ (OCR)** เพื่อดึงข้อความออกมา

5. Backend นำ **(A) ข้อความจากภาพ** + **(B) คำถามผู้ใช้** ไปค้นหาใน **Vector DB**
